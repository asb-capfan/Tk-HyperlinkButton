# This Makefile is for the Tk::HyperlinkButton extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Tk/HyperlinkButton.pm]
#     AUTHOR => [q[Alexander Becker <asb@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ repository=>q[https://github.com/asb-capfan/Tk-HyperlinkButton] } }
#     MIN_PERL_VERSION => q[5.016003]
#     NAME => q[Tk::HyperlinkButton]
#     PREREQ_PM => { Browser::Open=>q[0.04], ExtUtils::MakeMaker=>q[6.98], Tk=>q[804] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Tk/HyperlinkButton.pm]
...
MAKE = gmake
FULLEXT = Tk\HyperlinkButton
BASEEXT = HyperlinkButton
PARENT_NAME = Tk
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Tk/HyperlinkButton.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Tk/HyperlinkButton.pm
...
DISTNAME = Tk-HyperlinkButton
DISTVNAME = Tk-HyperlinkButton-0.02
...
HyperlinkButton.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Tk::HyperlinkButton\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "  - 'Alexander Becker <asb@cpan.org>'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Tk-HyperlinkButton" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Browser::Open: '0.04'" >> META_new.yml
	$(NOECHO) $(ECHO) "  ExtUtils::MakeMaker: '6.98'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Tk: '804'" >> META_new.yml
	$(NOECHO) $(ECHO) "  perl: '5.016003'" >> META_new.yml
	$(NOECHO) $(ECHO) resources: >> META_new.yml
	$(NOECHO) $(ECHO) "  repository: https://github.com/asb-capfan/Tk-HyperlinkButton" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "      \"Alexander Becker ^<asb^@cpan.org^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Tk-HyperlinkButton\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Browser::Open\" : \"0.04\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"ExtUtils::MakeMaker\" : \"6.98\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Tk\" : \"804\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"perl\" : \"5.016003\"" >> META_new.json
	$(NOECHO) $(ECHO) "         }" >> META_new.json
	$(NOECHO) $(ECHO) "      }" >> META_new.json
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"url\" : \"https://github.com/asb-capfan/Tk-HyperlinkButton\"" >> META_new.json
	$(NOECHO) $(ECHO) "      }" >> META_new.json
	$(NOECHO) $(ECHO) "   }," >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Tk-HyperlinkButton\" VERSION=\"0.02\">" > Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT></ABSTRACT>" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Alexander Becker &lt;asb@cpan.org&gt;</AUTHOR>" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <PERLCORE VERSION=\"5,016003,0,0\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Browser::Open\" VERSION=\"0.04\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"ExtUtils::MakeMaker\" VERSION=\"6.98\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Tk::\" VERSION=\"804\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.28\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> Tk-HyperlinkButton.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> Tk-HyperlinkButton.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Tk/HyperlinkButton.pm blib\lib\Tk\HyperlinkButton.pm 
